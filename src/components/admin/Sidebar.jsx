...
import { LayoutDashboard, Users, Calendar, Bell, Settings, LogOut, X } from 'lucide-react';
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="h-16 flex items-center justify-between px-6 border-b border-gray-100">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-bold text-gray-800 tracking-tight">TapTime</span>
            </div>
          ...
          <div className="p-4 border-t border-gray-100">
            <button className="flex cursor-pointer items-center w-full px-4 py-3 text-sm font-semibold text-gray-500 hover:bg-orange-50 hover:text-orange-600 rounded-xl transition-all">
